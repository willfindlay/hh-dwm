...
static const char col_cyan[]        = "#3b84c0"; /* border color focused windows and tags */
...
static const char *termcmdlastwin[]  = { "termite", "-d", "$(cat ~/.last_dir)", NULL };

static Key keys[] = {
    /* modifier                     key        function        argument */
    { MODKEY,                       XK_d,      spawn,          {.v = dmenucmd } },
    { MODKEY,                       XK_Return, spawn,          {.v = termcmd } },
    { MODKEY|ShiftMask,             XK_Return, spawn,          {.v = termcmdlastwin } },
